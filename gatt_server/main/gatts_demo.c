...
const mb_parameter_descriptor_t device_parameters[] = {
    {CID_Read_value, "Value", "%", MB_DEVICE_ADDR1, MB_PARAM_HOLDING, 0, 2,
     offsetof(holding_reg_params_t, test_regs) + 1, PARAM_TYPE_U8, 4,
     {.opt1 = 0, .opt2 = 100, .opt3 = 1}, PAR_PERMS_READ_WRITE_TRIGGER},
    {CID_Write_value, "Sending_Value", "%", MB_DEVICE_ADDR1, MB_PARAM_HOLDING, 4, 2,
     offsetof(holding_reg_params_t, slave_regs) + 1, PARAM_TYPE_U8, 4,
     {.opt1 = 0, .opt2 = 100, .opt3 = 1}, PAR_PERMS_READ_WRITE_TRIGGER},

	 { CID_INPUT_REG, "INPUT_REG", "%", MB_DEVICE_ADDR1, MB_PARAM_INPUT, 0, 2,
			 offsetof(input_reg_params_t,data), PARAM_SIZE_U8, 4,{.opt1 = -10, .opt2 = 10, .opt3 = 1}, PAR_PERMS_READ_WRITE_TRIGGER },
};
...
#define GATTS_SERVICE_UUID_TEST_B   0x00AB
#define GATTS_CHAR_UUID_TEST_B      0xEE01
#define GATTS_DESCR_UUID_TEST_B     0x2222
#define GATTS_NUM_HANDLE_TEST_B     4

#define TEST_DEVICE_NAME            "AWT_OTA_TESTING"
